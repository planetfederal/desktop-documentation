# -*- coding: utf-8 -*-
#
# Boundless Desktop documentation build configuration file, created by
...
autodoc_mock_imports = ["qgis", "qgiscommons2", "yaml"]
...
# pixels large.
html_favicon = '../themes/boundless_doc/static/favicon_desktop.ico'
...
htmlhelp_basename = 'BoundlessDesktopdoc'
...
latex_documents = [
  ('index', 'BoundlessDesktop.tex', u'Boundless Desktop Documentation',
   u'Boundless', 'manual'),
]
...
man_pages = [
    ('index', 'boundlessdesktop', u'Boundless Desktop Documentation',
     [u'Boundless'], 1)
]
...
texinfo_documents = [
  ('index', 'BoundlessDesktop', u'Boundless Desktop Documentation',
   u'Boundless', 'BoundlessDesktop', 'One line description of project.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {'https://docs.qgis.org/testing/en/': None}
